      ...
      <Table>
        <TableHeader className="[&_tr]:border-none">
          <TableRow className="bg-zinc-900 hover:bg-zinc-900 [&>th]:px-4">
            ...
            <TableHead className="h-11 w-14 min-w-14 text-center text-white">編集</TableHead>
            <TableHead className="h-11 w-14 min-w-14 text-center text-white last:rounded-tr-lg">削除</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {items.map((item) => (
